...
threads = [
    ...
    {'tag': 'punch line', 'text': "Один AI запускает 50 копий себя для решения одной задачи. А тебя на собесе спрашивают умеешь ли ты работать в команде.", 'label': '#ai'},
    ...
    {'tag': 'narrative judo', 'text': "Мы думаем что ИИ это что-то воздушное, в облаке. Нет. Один серверный шкаф NVIDIA весит 3 тонны и состоит из 1.3 миллиона компонентов. Это тяжелая промышленность. Просто с интерфейсом чат-бота.", 'label': '#tech'},
]
...
x_posts = [
    ...
    {'tag': 'punch line', 'text': 'One AI spawns 50 copies of itself to solve a single problem.\n\nAnd they ask you in interviews if you\'re a "team player."'},
